...
## Description 
### This app simplifies and streamlines the process of creating HTML code for use within NAVEX IRM. It converts HTML code into a C# string that can be used within the NAVEX IRM Formula Engine to render HTML in a record. HTML files can also be imported into the app and copy/pasted into the Rich Text Editor for editing and previewing files before adding them to IRM. This app can also be used to create HTML templates for email notifications sent from IRM to it's users. The Rich Text Editor within the app includes many useful tools for editing HTML and CSS without needing very much knowledge of coding syntax. For example, you can insert tables, links and lists, as well as edit spacing, alignment, font and more without writing any code.  
